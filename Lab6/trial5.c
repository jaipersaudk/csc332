...
void *smokerI (int i) {
   while (1) {
      ...
      if (table_used==0) {
	    ...
	    if (i==0) {
               printf ( "smoker with tobacco completed his smoking\n" );
	       printf ( "**********************************************\n");
            }
	    else if (i==1) {
               printf ( "smoker with paper completed his smoking\n" );
               printf ( "**********************************************\n");
	    }
            else if (i==2) {
	       printf ( "smoker with matches completed his smoking\n" );
               printf ( "**********************************************\n");
            }
            else
